...
export default function filterPointsInRegion(
  ...
  const geo = regionGeo as FeatureCollection<Geometry, GeoJsonProperties> | Feature<Geometry, GeoJsonProperties>;

  const features =
    (geo as FeatureCollection<Geometry, GeoJsonProperties>).features || [geo as Feature<Geometry, GeoJsonProperties>];
