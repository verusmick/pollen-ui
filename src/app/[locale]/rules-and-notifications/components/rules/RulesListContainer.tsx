...
export function RulesListContainer() {
  const t = useTranslations('messageSystemPage.rules.list.states');
  const tableT = useTranslations('messageSystemPage.rules.list.table');
